...
function SchemerGenerate()
  ...
  apply_colort(schemer_cmds, { guifg=panel, guibg=literals:lighten_to(0.75) }, "Search")
  apply_colort(schemer_cmds, { guifg="#0C0C0C", guibg=literals:lighten_to(0.85) }, "CurSearch")
  apply_colort(schemer_cmds, { guifg="#0C0C0C", guibg=primary }, "IncSearch")
