...
function SchemerGenerate()
  ...
  apply_colort(schemer_cmds, { guifg=panel, guibg=secondary }, "Search")
  apply_colort(schemer_cmds, { guifg="#0C0C0C", guibg=literals:lighten_to(0.55) }, "CurSearch")
  apply_colort(schemer_cmds, { guifg="#0C0C0C", guibg=literals:lighten_to(0.75) }, "IncSearch")
